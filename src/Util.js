...
module.exports = class Util {
    ...
    */
    ...
    static parseCommand(string, commandName, {
    ...
    static downloadAndSaveTempResource(url, extension, callback) {
    ...
    static buildPrettyUserName(user) {
        let name = "";
    ...
    static buildPrettyChatName(chat) {
        let name = "";
